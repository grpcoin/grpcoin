...
var file_grpcoin_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x61, 0x70, 0x69, 0x2f, 0x67,
	0x72, 0x70, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_grpcoin_proto_depIdxs = []int32{
	...
	2,  // 2: grpcoin.PortfolioResponse.cash_usd:type_name -> grpcoin.Amount
	7,  // 3: grpcoin.PortfolioResponse.positions:type_name -> grpcoin.PortfolioPosition
	9,  // 4: grpcoin.PortfolioPosition.ticker:type_name -> grpcoin.PortfolioPosition.Ticker
	2,  // 5: grpcoin.PortfolioPosition.amount:type_name -> grpcoin.Amount
	0,  // 6: grpcoin.TickerInfo.Watch:input_type -> grpcoin.QuoteTicker
	3,  // 7: grpcoin.Account.TestAuth:input_type -> grpcoin.TestAuthRequest
	5,  // 8: grpcoin.PaperTrade.Portfolio:input_type -> grpcoin.PortfolioRequest
	1,  // 9: grpcoin.TickerInfo.Watch:output_type -> grpcoin.Quote
	4,  // 10: grpcoin.Account.TestAuth:output_type -> grpcoin.TestAuthResponse
	6,  // 11: grpcoin.PaperTrade.Portfolio:output_type -> grpcoin.PortfolioResponse
